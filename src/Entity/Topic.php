...
class Topic
{
     ...
     * @Assert\Length(min=5, max=30, minMessage="Le titre doit contenir au moins 5 caractères.", maxMessage="Le titre doit contenir moins de 30 caractères.")
     */
    private $title;
    ...
    {
        if ($this->posts->last() === False) {
            return null; 
        } else {
            return $this->posts->last()->getCreatedAt(); 
        }
    }
